...
void Update()
{
    if (Input.GetKeyDown(KeyCode.Escape))
    {
        ...
        else if (GameStateManager.Instance != null && GameStateManager.Instance.IsGameOver)
        {
...
{
    bool isGameOver = GameStateManager.Instance != null && GameStateManager.Instance.IsGameOver;
