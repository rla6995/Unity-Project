...
public class MergeHeadController : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        // ✅ JudgeInputHandler에 자신을 등록
        if (JudgeInputHandler.Instance != null)
        {
            JudgeInputHandler.Instance.RegisterHeadController(this);
        }
    }
    ...
    private void OnDisable()
    {
        ...
        // ✅ JudgeInputHandler에서 자신을 제거
        if (JudgeInputHandler.Instance != null)
        {
            JudgeInputHandler.Instance.UnregisterHeadController(this);
        }
    }
